...
urlpatterns = [
    ...
    path('subservicio/<int:subservicio_id>/modificar/', views.modificar_subservicio, name='modificar_subservicio'),
    path('subservicio/<int:id_subservicio>/guardar-modificacion/', views.guardar_modificacion_subservicio, name='guardar_modificacion_subservicio'),
    path('subservicio/<int:subservicio_id>/eliminar/', views.eliminar_subservicio, name='eliminar_subservicio'),
]